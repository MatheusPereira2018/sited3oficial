...
const HeroSection = () => {
  ...
  return (
    <section ref={ref} className="min-h-[85vh] flex items-center relative overflow-hidden pt-24 pb-16">
      <motion.div 
        style={{ y: backgroundY }}
        className="absolute inset-0 bg-gradient-to-br from-purple-500/10 via-background to-pink-500/5" 
      />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-500/10 border border-purple-500/30 text-purple-500 text-sm font-medium mb-6">
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            ChackApp:{" "}
            <span className="gradient-text">do campo ao BI em tempo real</span>
          </h1>
          
          <p className="text-muted-foreground text-lg md:text-xl leading-relaxed mb-10 max-w-2xl mx-auto">
            Coleta de dados em campo via app mobile com integração em tempo real 
            ao BI corporativo, eliminando retrabalho e erros de digitação.
          </p>
          ...
          >
            <a href="#contato-case">
              Quero otimizar minha operação de campo
  ...
  const problems = [
    {
      ...
      description: "Equipes em campo coletavam informações em papel ou planilhas offline, sujeitas a perda ou erro."
    },
    {
      icon: Clock,
      title: "Retrabalho na digitação",
      description: "Dados coletados em campo precisavam ser digitados manualmente no sistema, gerando retrabalho e erros."
    },
    {
      icon: Database,
      title: "Falta de sincronização",
      description: "Informações coletadas em campo demoravam dias para chegar ao sistema corporativo."
    },
    {
      icon: Target,
      title: "Visibilidade limitada",
      description: "Impossível acompanhar operações de campo em tempo real ou tomar decisões rápidas."
    }
  ];
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Operações de campo desconectadas do sistema corporativo, gerando retrabalho e perda de informações.
          </p>
        </motion.div>
...
const SolutionSection = () => {
  ...
  const steps = [
    { icon: Smartphone, label: "App Mobile", sublabel: "coleta em campo" },
    { icon: Cloud, label: "Sincronização", sublabel: "em tempo real" },
    { icon: Database, label: "Integração", sublabel: "com BI corporativo" },
    { icon: BarChart3, label: "Dashboard", sublabel: "de operações" },
  ];
    ...
    <section ref={ref} className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Desenvolvemos um app mobile conectado diretamente ao BI corporativo, eliminando retrabalho.
          </p>
        </motion.div>
          ...
          <div className="glass-card p-8 rounded-2xl border-primary/30">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h4 className="font-bold mb-2">App Mobile Nativo</h4>
                <p className="text-sm text-muted-foreground">Aplicativo desenvolvido para iOS e Android com interface intuitiva para coleta de dados em campo.</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 rounded-xl bg-primary/10 flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-sm text-muted-foreground">Dados coletados são sincronizados automaticamente com o sistema corporativo quando há conexão.</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 rounded-xl bg-primary/10 flex items-center justify-center mx-auto mb-4">
                  <BarChart3 className="w-8 h-8 text-primary" />
                </div>
                <h4 className="font-bold mb-2">BI Integrado</h4>
                <p className="text-sm text-muted-foreground">Dados aparecem automaticamente no dashboard corporativo, sem necessidade de digitação.</p>
              </div>
            </div>
          </div>
        </motion.div>
...
const ResultsSection = () => {
  ...
  const results = [
    { icon: Zap, value: "100%", label: "eliminação de retrabalho" },
    { icon: Clock, value: "Tempo real", label: "sincronização de dados" },
    { icon: CheckCircle2, value: "Zero", label: "erros de digitação" },
  ];
          ...
          <div className="glass-card p-10 md:p-16 rounded-3xl border-primary/30 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h2 className="font-display text-2xl md:text-4xl font-bold mb-4">
                Quer otimizar sua{" "}
                <span className="gradient-text">operação de campo?</span>
              </h2>
              <p className="text-muted-foreground text-lg mb-8 max-w-xl mx-auto">
                Conecte suas equipes de campo ao sistema corporativo. Vamos conversar sobre seu caso.
              </p>
              <Button 
                size="lg" 
